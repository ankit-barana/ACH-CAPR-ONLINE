...
class Welcome extends Component {
  ...
  componentDidMount() {
// Here you need to set the type of test (audio, visual, choice)
// then set the stimuli threshold for a correct response (stimuli > 0 = correct thresh = 0)
// this is usually defined in Trial_P in the trialCompleteRenderer method

    localStorage.setItem("testType", "audio");
    localStorage.setItem("thresh", 0)
      ...
      <div className="Welcome">
        ...
        <div className="text-container">
          <p className="Welcome-text">
            ...
            <br /><br /> A loud noise similar to radio static will play througout the task.
